...
function StructuresTeacher() {
  ...
  useEffect(() => {
    ...
    //       `${process.env.NEXT_PUBLIC_BACKEND_URL}/structures/getStructures`,
    //       {
    //         method: "GET",
    //         credentials: "include",
    //       },
    ...
    //En attendant que back fonctionne
    setStructuresData(dataStructures);
  }, [addFlag]);
  ...
  const deleteStructure = async (comingProps) => {
    ...
    // try {
    //   const response = await fetch(
    //     `${process.env.NEXT_PUBLIC_BACKEND_URL}/structures/deleteStructure/${comingProps._id}`,
    //     {
    //       method: "DELETE",
    //       credentials: "include",
    //     },
    ...
    // En attendant que back ok
    dataStructures = dataStructures.filter(
      (stru) => stru._id !== comingProps._id,
    );
    setAddFlag(!addFlag);
  };

  const handleAddStructure = async (newStructure) => {
    console.log("Ajouter structure", newStructure);
    // if (
    //   newStructure.name !== "" &&
    ...
    //   try {
    //     const response = await fetch(
    //       `${process.env.NEXT_PUBLIC_BACKEND_URL}/structures/add`,
    //       {
    //         method: "POST",
    //         credentials: "include",
    //         headers: {
    ...
    //           weekHourLoad: newStructure.weekHourLoad,
