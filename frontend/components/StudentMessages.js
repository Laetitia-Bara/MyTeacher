...
export default function StudentMessages() {
  ...
  useEffect(() => {
    ...
    const handleMessagesReadUpdate = ({ conversationId, readBy }) => {
      ...
      if (String(conversationId) === String(selectedConversationId)) {
        setMessages((prev) =>
          prev.map((msg) => {
            if (msg.senderRole === "student") return msg;
            if ((msg.readBy || []).includes("student")) return msg;
            return {
              ...msg,
              readBy: [...(msg.readBy || []), "student"],
            };
          }),
        );
      }
  ...
  }, [socket, selectedConversationId, token]);
    ...
    <div className={styles.page}>
      ...
      <div className={styles.wrapper}>
        <aside className={styles.sidebar}>
          <div className={styles.sidebarHeader}>Messagerie</div>
